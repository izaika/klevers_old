...
{
	const ANIMATE_FILL 		= 0;
	const ANIMATE_STROKE	= 1;
	...
	public static $FILE_STORAGE_PATH = 'assets/c_icons/';

	public static $file_uid_field_name 	= 'icon_uid';
	public static $file_name_field_name = 'icon_filename';
	public static $file_size_field_name = 'icon_filesize';

	const DOWLOAD_CONTROLLER_PATH = 'caticonfile/';
