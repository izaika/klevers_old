...
class URL extends Kohana_URL {
	...
	public static function site($uri = '', $protocol = NULL, $index = TRUE)
	{
		...
		// Concat the URL
		if ($protocol && Kohana::$environment == Kohana::DEVELOPMENT && trim(`hostname`) == 'izaika.local') {
			return UTF8::str_ireplace('izaika.local', 'izaika.dev.sumy.net', URL::base($protocol, $index).$path);
		} else {
